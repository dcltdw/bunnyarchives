<!-- CHECKPOINT — disaster-recovery snapshot, 20260831T202338
     State: attendance thread (#5) closed — event-level records with capacity field; on-site tracking parked in §20.
