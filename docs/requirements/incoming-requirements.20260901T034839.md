<!-- CHECKPOINT — disaster-recovery snapshot, 20260901T034839
     State: #9/#10 closed — phases tile the event w/ time ranges (game off, anytime), delayed derived + dashboard emphasis.
