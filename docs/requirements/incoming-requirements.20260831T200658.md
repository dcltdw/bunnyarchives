<!-- CHECKPOINT — disaster-recovery snapshot, 20260831T200658
     State: NPC/Character thread (#2) closed — kind discriminator, PC-only rules, uncapped person-owned NPCs, rescue-after.
